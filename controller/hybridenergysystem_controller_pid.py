...
class SimpleControl(BaseAlgorithm):
    ...
    def predict(self, observation, state=None, mask=None, deterministic=False):
        ...
        Steuerung_BESS= PID(1,0, 0.1,  60, 14000, 0)
        Steuerung_KESS= PID(0.2, 0, 15, 60, 40000, 0)
        ...
        for observation in observations:
            ...
            # control variables
            #consumption = observation['d_usage']
            consumption = observation['p_usage_30s']

            #################
            # CONTROL RULES #
            #################
            BESS_PID_input = PID.output(Steuerung_BESS, y_measured = consumption)/ 14000
            KESS_PID_input = PID.output(Steuerung_KESS, y_measured = consumption)/ 40000
            ...
            action['u_powerbess'] = BESS_PID_input
            action['u_powerkess'] = KESS_PID_input

            # if BESS_PID_input > 14000:
            #    action['u_powerbess'] = -1
            # else:
            #     action['u_powerbess'] = BESS_PID_input/ 14000
            ...
            # if consumption < 5000 :
            #     if consumption < 3000 :
            #         action['u_powerkess'] = 0.5
            #     else:
            #         action['u_powerkess'] = 0.1   
            #     action['u_powerbess'] = 1.0
            # else:   
            #    action['u_powerbess'] = 0.1
            
            # if consumption > 15000 :
            #     action['u_powerbess'] = -1.0
            # if consumption > 25000 : 
...
class PID():
    ...
    def __init__(self,kp, ki, kd, dt, set_point, windupMax=0):
